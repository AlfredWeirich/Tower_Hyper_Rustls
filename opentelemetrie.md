...
Dort kannst du links unter "Service" deinen Server (z.B. `chatapp_server` oder `proxy_server`) auswählen und auf "Find Traces" klicken, um die visualisierten Spans zu sehen.
